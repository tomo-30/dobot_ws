...
#include "dobot_msgs_v3/srv/detail/move_jog__rosidl_typesupport_fastrtps_c.h"
...
#include "dobot_msgs_v3/srv/detail/move_jog__struct.h"
#include "dobot_msgs_v3/srv/detail/move_jog__functions.h"
...
using _MoveJog_Request__ros_msg_type = dobot_msgs_v3__srv__MoveJog_Request;
...
size_t get_serialized_size_dobot_msgs_v3__srv__MoveJog_Request(
  const void * untyped_ros_message,
...
static uint32_t _MoveJog_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__MoveJog_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__MoveJog_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3__srv__MoveJog_Request;
    is_plain =
      (
...
static size_t _MoveJog_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__MoveJog_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, MoveJog_Request)() {
...
using _MoveJog_Response__ros_msg_type = dobot_msgs_v3__srv__MoveJog_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t get_serialized_size_dobot_msgs_v3__srv__MoveJog_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveJog_Response__ros_msg_type * ros_message = static_cast<const _MoveJog_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__MoveJog_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__MoveJog_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3__srv__MoveJog_Response;
    is_plain =
      (
...
static size_t _MoveJog_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__MoveJog_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, MoveJog_Response)() {
...
// already included above
// #include "dobot_msgs_v3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_msgs_v3/srv/move_jog.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, MoveJog)() {
