...
#include "dobot_msgs_v3/srv/detail/circle__rosidl_typesupport_fastrtps_c.h"
...
#include "dobot_msgs_v3/srv/detail/circle__struct.h"
#include "dobot_msgs_v3/srv/detail/circle__functions.h"
...
using _Circle_Request__ros_msg_type = dobot_msgs_v3__srv__Circle_Request;
...
size_t get_serialized_size_dobot_msgs_v3__srv__Circle_Request(
  const void * untyped_ros_message,
...
static uint32_t _Circle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__Circle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__Circle_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3__srv__Circle_Request;
    is_plain =
      (
...
static size_t _Circle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__Circle_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, Circle_Request)() {
...
using _Circle_Response__ros_msg_type = dobot_msgs_v3__srv__Circle_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t get_serialized_size_dobot_msgs_v3__srv__Circle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Circle_Response__ros_msg_type * ros_message = static_cast<const _Circle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__Circle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__Circle_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3__srv__Circle_Response;
    is_plain =
      (
...
static size_t _Circle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__Circle_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, Circle_Response)() {
...
// already included above
// #include "dobot_msgs_v3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_msgs_v3/srv/circle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, Circle)() {
