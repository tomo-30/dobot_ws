...
#include "dobot_msgs_v3/srv/detail/get_hold_regs__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3::srv::GetHoldRegs_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::GetHoldRegs_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::GetHoldRegs_Request *>(
    untyped_ros_message);
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_GetHoldRegs_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3::srv::GetHoldRegs_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::GetHoldRegs_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::GetHoldRegs_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_GetHoldRegs_Response__handle;
}
...
static rosidl_service_type_support_t _GetHoldRegs__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_GetHoldRegs__handle;
}
