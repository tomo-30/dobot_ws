...
#include "dobot_msgs_v3/srv/detail/circle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs_v3::srv::Circle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v3::srv::Circle_Request & ros_message)
{
  // Member: count
  cdr >> ros_message.count;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3::srv::Circle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::Circle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::Circle_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<dobot_msgs_v3::srv::Circle_Request>()
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, Circle_Request)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs_v3
cdr_serialize(
  const dobot_msgs_v3::srv::Circle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: res
  cdr << ros_message.res;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v3::srv::Circle_Response & ros_message)
{
  // Member: res
  cdr >> ros_message.res;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3::srv::Circle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::Circle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dobot_msgs_v3
const rosidl_message_type_support_t *
get_message_type_support_handle<dobot_msgs_v3::srv::Circle_Response>()
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, Circle_Response)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle_Response__handle;
}
...
get_service_type_support_handle<dobot_msgs_v3::srv::Circle>()
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, Circle)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_Circle__handle;
}
