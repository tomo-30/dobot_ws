...
#include "dobot_msgs_v3/srv/detail/set_arm_orientation__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dobot_msgs_v3::srv::SetArmOrientation_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v3::srv::SetArmOrientation_Request & ros_message)
{
  // Member: lorr
  cdr >> ros_message.lorr;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3::srv::SetArmOrientation_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::SetArmOrientation_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::SetArmOrientation_Request *>(
    untyped_ros_message);
...
static size_t _SetArmOrientation_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetArmOrientation_Request(full_bounded, is_plain, 0);
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, SetArmOrientation_Request)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dobot_msgs_v3
cdr_serialize(
  const dobot_msgs_v3::srv::SetArmOrientation_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: res
  cdr << ros_message.res;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dobot_msgs_v3::srv::SetArmOrientation_Response & ros_message)
{
  // Member: res
  cdr >> ros_message.res;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3::srv::SetArmOrientation_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dobot_msgs_v3::srv::SetArmOrientation_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dobot_msgs_v3::srv::SetArmOrientation_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _SetArmOrientation_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetArmOrientation_Response(full_bounded, is_plain, 0);
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, SetArmOrientation_Response)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation_Response__handle;
}
...
{
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dobot_msgs_v3, srv, SetArmOrientation)() {
  return &dobot_msgs_v3::srv::typesupport_fastrtps_cpp::_SetArmOrientation__handle;
}
